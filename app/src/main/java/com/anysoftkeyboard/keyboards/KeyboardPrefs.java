...
public class KeyboardPrefs {
    ...
    public static String getDefaultDomain(@NonNull Context appContext) {
        return getString(appContext, R.string.settings_key_default_domain_text, R.string.settings_default_default_domain_text).trim();
    }

    private static String getString(@NonNull Context appContext, @StringRes int prefKey, @StringRes int defaultValue) {
        return prefs(appContext).getString(prefKey, defaultValue).get();
    }

    private static boolean getBoolean(@NonNull Context appContext, @StringRes int prefKey, @BoolRes int defaultValue) {
