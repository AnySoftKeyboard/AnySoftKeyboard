...
public class QuickTextSettingsFragmentTest  extends RobolectricFragmentTestCase<QuickTextSettingsFragment> {

    @Test
    @Config(sdk = Build.VERSION_CODES.N)
    public void testVisibleAtN() {
        final Preference preference = startFragment().findPreference("settings_key_default_emoji_skin_tone");
