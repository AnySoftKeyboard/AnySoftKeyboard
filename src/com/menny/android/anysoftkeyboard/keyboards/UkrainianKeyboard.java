...
public class UkrainianKeyboard extends AnyKeyboard implements HardKeyboardTranslator
{
	...
	{
		super(context, KeyboardFactory.UK_KEYBOARD, getKeyboardId(context), false, R.string.uk_keyboard, false, Dictionary.Language.Ukrainian, R.drawable.uk);
	}
	
	private static int getKeyboardId(AnyKeyboardContextProvider context) 
	{
		if (context.getSharedPreferences().getBoolean(KeyboardFactory.UK_KEYBOARD_4_ROWS, true))
