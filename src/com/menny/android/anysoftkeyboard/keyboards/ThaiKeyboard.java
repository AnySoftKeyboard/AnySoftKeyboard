...
public class ThaiKeyboard extends AnyKeyboard /*implements HardKeyboardTranslator*/
{
	...
	{
		super(context, KeyboardFactory.THAI_KEYBOARD, R.xml.thai_qwerty, true, R.string.thai_keyboard, true, Dictionary.Language.None, R.drawable.sym_keyboard_notification_icon);
	}
