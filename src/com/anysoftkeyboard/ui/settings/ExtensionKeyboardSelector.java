...
public class ExtensionKeyboardSelector extends AddOnSelector<KeyboardExtension> {
	...
	protected int getPrefsLayoutResId() {
		return R.xml.prefs_addon_extension_keyboard_selector;
	}
	...
	protected AddOn getCurrentSelectedAddOn() {
		return KeyboardExtensionFactory.getCurrentKeyboardExtension(getApplicationContext(), KeyboardExtension.TYPE_EXTENSION);
	}
}