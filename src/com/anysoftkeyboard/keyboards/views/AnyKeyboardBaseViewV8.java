...
public class AnyKeyboardBaseViewV8 extends AnyKeyboardBaseViewV7 {

	public AnyKeyboardBaseViewV8(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}
	
	public AnyKeyboardBaseViewV8(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	
	protected String getKeyboardViewNameForLogging()
    {
    	return "AnyKeyboardBaseViewV8";
    }
