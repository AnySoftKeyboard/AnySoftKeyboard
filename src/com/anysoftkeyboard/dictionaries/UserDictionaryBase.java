...
public abstract class UserDictionaryBase extends EditableDictionary {
	 ...
	 * 
	 * @param word
	 *            the word to add. If the word is capitalized, then the
	 *            dictionary will recognize it as a capitalized word when
	 *            searched.
	 * @param frequency
	 *            the frequency of occurrence of the word. A frequency of 255 is
	 ...
	 * 
	 * @param roots
	 *            node whose children have to be search for matches
	 * @param codes
	 *            the input character codes
	 * @param word
	 *            the word being composed as a possible match
	 * @param depth
	 *            the depth of traversal - the length of the word being composed
	 *            thus far
	 * @param completion
	 *            whether the traversal is now in completion mode - meaning that
	 *            we've exhausted the input and we're looking for all possible
	 *            suffixes.
	 * @param snr
	 *            current weight of the word being formed
	 * @param inputIndex
	 *            position in the input characters. This can be off from the
