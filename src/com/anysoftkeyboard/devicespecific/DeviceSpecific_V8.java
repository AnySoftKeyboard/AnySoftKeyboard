...
public class DeviceSpecific_V8 extends DeviceSpecific_V7 {
	...
	public DeviceSpecific_V8(Context context) {
		super(context);
	}

	public DeviceSpecific_V8(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	 
	public DeviceSpecific_V8(Context context, AttributeSet attrs, int defStyle) {
