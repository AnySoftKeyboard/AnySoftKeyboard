...
static jlong nativeime_NextWordDictionary_open(JNIEnv *env, jclass clazz,
                                               jstring filename) {
  NextWordDictionary *dictionary =
      new NextWordDictionary(env->GetStringUTFChars(filename, 0));
  return (jlong)dictionary;
}

static void nativeime_NextWordDictionary_close(JNIEnv *env, jclass clazz,
                                               jlong dict) {
...
static void nativeime_NextWordDictionary_load(JNIEnv *env, jclass clazz,
                                              jlong dict) {
  NextWordDictionary *dictionary = (NextWordDictionary *)dict;
  dictionary->load();
}

static void nativeime_NextWordDictionary_clear(JNIEnv *env, jclass clazz,
                                               jlong dict) {
  NextWordDictionary *dictionary = (NextWordDictionary *)dict;
  dictionary->clear();
}
...
static JNINativeMethod gMethods[] = {
    {"openNative", "(Ljava/lang/String;)J",
     (void *)nativeime_NextWordDictionary_open},
...
static int registerNatives(JNIEnv *env) {
  const char *const kClassPathName =
      "com/anysoftkeyboard/nextword/NextWordDictionary";
