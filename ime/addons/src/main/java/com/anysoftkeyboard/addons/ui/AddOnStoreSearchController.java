...
public class AddOnStoreSearchController {
    ...
    public AddOnStoreSearchController(@NonNull Context context, @NonNull String keyword) {
        ...
        mDialogController = new GeneralDialogController(context, R.style.Theme_AskAlertDialog, this::setupDialog);
    }

    private void setupDialog(Context context, AlertDialog.Builder builder, int optionId, @Nullable Object data) {
        switch (optionId) {
            case LEAVE:
                builder
