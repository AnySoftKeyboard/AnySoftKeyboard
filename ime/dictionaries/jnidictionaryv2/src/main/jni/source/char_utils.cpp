  ...
  for (unsigned short c = 0; c < 0xFFFF; c++) {
    ...
    if (c != icu4cLowerC) {
      ...
      printf("0x%04X, 0x%04X\n", c, icu4cLowerC);
         ...
         *      while(<>){/0x(\w*), 0x(\w*)/; @lines = grep(/^$1/, @buf); @cols =
         * split(/;/, $lines[0]); \         print "    { 0x$1, 0x$cols[13] },  // $cols[1]\n";}'
         *
         * 5. Update the SORTED_CHAR_MAP[] array below with the output above.
         *    Then, rebuild with -DCONFIRMING_CHAR_UTILS and confirm the program exits
         * successfully.         $ g++ -o char_utils -I.. -DUPDATING_CHAR_UTILS
         * -DCONFIRMING_CHAR_UTILS char_utils.cpp -licuuc         $ ./char_utils
         *    $
         */

// TODO: Use size_t instead of int.
// Disclaimer: You will see a compile error if you use this macro against a
// variable-length array. Sorry for the inconvenience. It isn't supported.
...
static const struct LatinCapitalSmallPair SORTED_CHAR_MAP[] = {
    ...
    {0x1F8D, 0x1F85},  // GREEK CAPITAL LETTER ALPHA WITH DASIA AND OXIA AND
                       // PROSGEGRAMMENI
    {0x1F8E, 0x1F86},  // GREEK CAPITAL LETTER ALPHA WITH PSILI AND PERISPOMENI
                       // AND PROSGEGRAMMENI
    {0x1F8F, 0x1F87},  // GREEK CAPITAL LETTER ALPHA WITH DASIA AND PERISPOMENI
                       // AND PROSGEGRAMMENI
    ...
    {0x1FAD, 0x1FA5},  // GREEK CAPITAL LETTER OMEGA WITH DASIA AND OXIA AND
                       // PROSGEGRAMMENI
    {0x1FAE, 0x1FA6},  // GREEK CAPITAL LETTER OMEGA WITH PSILI AND PERISPOMENI
                       // AND PROSGEGRAMMENI
    {0x1FAF, 0x1FA7},  // GREEK CAPITAL LETTER OMEGA WITH DASIA AND PERISPOMENI
                       // AND PROSGEGRAMMENI
...
static int compare_pair_capital(const void *a, const void *b) {
  return static_cast<int>(*static_cast<const unsigned short *>(a)) -
         static_cast<int>(
             (static_cast<const struct LatinCapitalSmallPair *>(b))->capital);
}

/* static */ int CharUtils::latin_tolower(const int c) {
  struct LatinCapitalSmallPair *p = static_cast<struct LatinCapitalSmallPair *>(
      bsearch(&c, SORTED_CHAR_MAP, NELEMS(SORTED_CHAR_MAP),
              sizeof(SORTED_CHAR_MAP[0]), compare_pair_capital));
...
/* static */ const unsigned short
    CharUtils::BASE_CHARS[CharUtils::BASE_CHARS_SIZE] = {
        /* U+0000 */ 0x0000,
        0x0001,
        0x0002,
        0x0003,
        ...
        // TODO: Check if it's really acceptable to consider Ø a diacritical
        // variant of O U+00DF: Manually changed from 00DF to 0073
        /* U+00E0 */ 0x0061,
        0x0061,
        0x0061,
        0x0061,
        ...
        // some (e.g. U+0180) it doesn't seem right. Ideally each code point
        // should be checked individually with all languages it's used in.
        /* U+0188 */ 0x0188,
        0x0189,
        0x018A,
        0x018B,
        ...
        // TODO: Check if it's really acceptable to consider Ø a diacritical
        // variant of O U+01FF: Manually changed from 00F8 to 006F
        // TODO: Check if it's really acceptable to consider ø a diacritical
        // variant of o
        /* U+0200 */ 0x0041,
        0x0061,
