...
public class WordComposerTest {
    ...
    public void testGetPossibleSubWordsWhenNoKeyIsNextToSpace() {
        ...
        final List<? extends KeyCodesProvider> possibleSubWords = wordComposer.getPossibleSubWords();
    ...
    public void testGetPossibleSubWordsWhenLastKeyIsNextToSpace() {
        ...
        for (int keyIndex=0; keyIndex<5; keyIndex++) {
            Assert.assertSame(wordComposer.getCodesAt(keyIndex), helloKeysProvider.getCodesAt(keyIndex));
        }
    }
    ...
    public void testGetPossibleSubWordsWhenFirstKeyIsNextToSpace() {
        ...
        Assert.assertEquals(5, helloKeysProvider.codePointCount());
        for (int keyIndex=0; keyIndex<5; keyIndex++) {
            Assert.assertSame(wordComposer.getCodesAt(keyIndex+1), helloKeysProvider.getCodesAt(keyIndex));
        }
    }
    ...
    public void testGetPossibleSubWordsWhenTwoFirstKeyIsNextToSpace() {
        ...
        Assert.assertEquals(5, helloKeysProvider.codePointCount());
        for (int keyIndex=0; keyIndex<5; keyIndex++) {
            Assert.assertSame(wordComposer.getCodesAt(keyIndex+2), helloKeysProvider.getCodesAt(keyIndex));
        }
    }
    ...
    public void testGetPossibleSubWordsWhenKeyIsNextToSpace() {
        WordComposer wordComposer = new WordComposer();
        typeWord(wordComposer, "hellonyellow",
                new boolean[]{false, false, false, false, false, true, false, false, false, false, false, false});
        final List<? extends KeyCodesProvider> possibleSubWords = wordComposer.getPossibleSubWords();
        ...
        for (int keyIndex=0; keyIndex<6; keyIndex++) {
            Assert.assertSame(wordComposer.getCodesAt(keyIndex+6), yellowKeysProvider.getCodesAt(keyIndex));
        }
    }
    ...
    public void testGetPossibleSubWordsReturnsMax() {
        WordComposer wordComposer = new WordComposer();
        typeWord(wordComposer, "hellonyellownbelow",
                new boolean[]{
        ...
        for (int keyIndex=6; keyIndex<12; keyIndex++) {
            Assert.assertSame(wordComposer.getCodesAt(keyIndex), yellowKeysProvider.getCodesAt(keyIndex-6));
        }
    }
}
