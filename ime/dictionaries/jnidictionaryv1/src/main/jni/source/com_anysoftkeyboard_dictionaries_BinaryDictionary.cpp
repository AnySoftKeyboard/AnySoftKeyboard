...
static jlong nativeime_BinaryDictionary_open(JNIEnv *env, jobject object,
...
static int nativeime_BinaryDictionary_getSuggestions(
  ...
  int count = dictionary->getSuggestions(
      inputCodes, arraySize, (unsigned short *)outputChars, frequencies,
...
static jboolean nativeime_BinaryDictionary_isValidWord(JNIEnv *env,
                                                       jobject object,
                                                       jlong dict,
...
static void nativeime_BinaryDictionary_close(JNIEnv *env, jobject object,
                                             jlong dict) {
  Dictionary *dictionary = (Dictionary *)dict;
...
static JNINativeMethod gMethods[] = {
    ...
    {"getSuggestionsNative", "(J[II[C[IIIII)I",
     (void *)nativeime_BinaryDictionary_getSuggestions},
    {"isValidWordNative", "(J[CI)Z",
     (void *)nativeime_BinaryDictionary_isValidWord}};
...
static int registerNatives(JNIEnv *env) {
  const char *const kClassPathName =
      "com/anysoftkeyboard/dictionaries/jni/BinaryDictionary";
  jclass clazz;
