...
public class SuggestTest {
  ...
  public void testDoesNotSuggestFixWhenLengthIsOne() {
    ...
    Mockito.doAnswer(
            invocation -> {
              final Dictionary.WordCallback callback = invocation.getArgument(1);
              callback.addWord("he".toCharArray(), 0, 2, 23, Mockito.mock(Dictionary.class));
              return null;
            })
        .when(mProvider)
        .getSuggestions(Mockito.any(), Mockito.any());
  ...
  public void testPrefersValidTypedToSuggestedFix() {
    ...
    Mockito.doAnswer(
            invocation -> {
              final Dictionary.WordCallback callback = invocation.getArgument(1);
              callback.addWord("works".toCharArray(), 0, 5, 23, Mockito.mock(Dictionary.class));
              callback.addWord("Works".toCharArray(), 0, 5, 23, Mockito.mock(Dictionary.class));
              return null;
            })
        .when(mProvider)
    ...
    Mockito.doAnswer(
            invocation -> {
              final Dictionary.WordCallback callback = invocation.getArgument(1);
              callback.addWord("Works".toCharArray(), 0, 5, 50, Mockito.mock(Dictionary.class));
              callback.addWord("works".toCharArray(), 0, 5, 23, Mockito.mock(Dictionary.class));
              return null;
            })
        .when(mProvider)
    ...
    Mockito.doAnswer(
            invocation -> {
              ...
              if (word.getTypedWord().equals("wfh")) {
                callback.addWord(
                    "work from home".toCharArray(), 0, 14, 23, Mockito.mock(Dictionary.class));
              }
              return null;
            })
        .when(mProvider)
  ...
  public void testAbbreviationsOverTakeDictionarySuggestions() {
    ...
    Mockito.doAnswer(
            invocation -> {
              ...
              if (word.getTypedWord().equals("hate")) {
                callback.addWord("love".toCharArray(), 0, 4, 23, Mockito.mock(Dictionary.class));
              }
              return null;
            })
        .when(mProvider)
    ...
    Mockito.doAnswer(
            invocation -> {
              final Dictionary.WordCallback callback = invocation.getArgument(1);
              callback.addWord("hate".toCharArray(), 0, 4, 23, Mockito.mock(Dictionary.class));
              callback.addWord("gate".toCharArray(), 0, 4, 25, Mockito.mock(Dictionary.class));
              callback.addWord("bate".toCharArray(), 0, 4, 20, Mockito.mock(Dictionary.class));
              callback.addWord("date".toCharArray(), 0, 4, 50, Mockito.mock(Dictionary.class));
              return null;
            })
        .when(mProvider)
        .getSuggestions(Mockito.any(), Mockito.any());
  ...
  public void testAutoTextIsQueriedEvenWithOneLetter() {
    ...
    inOrder.verify(mProvider).getSuggestions(Mockito.same(wordComposer), Mockito.any());
    Assert.assertEquals(
        -1 /*ill is not a valid word in the test*/, mUnderTest.getLastValidSuggestionIndex());
  }
  ...
  public void testCorrectlyPrioritizeFixes_1() {
    ...
    Mockito.doAnswer(
            invocation -> {
              final Dictionary.WordCallback callback = invocation.getArgument(1);
              callback.addWord("Jello".toCharArray(), 0, 5, 24, Mockito.mock(Dictionary.class));
              callback.addWord("hello".toCharArray(), 0, 5, 23, Mockito.mock(Dictionary.class));
              return null;
            })
        .when(mProvider)
  ...
  public void testCorrectlyPrioritizeFixes_2() {
    ...
    Mockito.doAnswer(
            invocation -> {
              final Dictionary.WordCallback callback = invocation.getArgument(1);
              callback.addWord("Jello".toCharArray(), 0, 5, 22, Mockito.mock(Dictionary.class));
              callback.addWord("hello".toCharArray(), 0, 5, 23, Mockito.mock(Dictionary.class));
              return null;
            })
        .when(mProvider)
  ...
  public void testCorrectlyPrioritizeFixes_5() {
    ...
    Mockito.doAnswer(
            invocation -> {
              ...
              callback.addWord("Jello".toCharArray(), 0, 5, 24, Mockito.mock(Dictionary.class));
              callback.addWord("hello".toCharArray(), 0, 5, 23, Mockito.mock(Dictionary.class));
              callback.addWord("cello".toCharArray(), 0, 5, 25, Mockito.mock(Dictionary.class));
              callback.addWord("following".toCharArray(), 0, 9, 29, Mockito.mock(Dictionary.class));
              return null;
            })
        .when(mProvider)
        .getSuggestions(Mockito.any(), Mockito.any());
