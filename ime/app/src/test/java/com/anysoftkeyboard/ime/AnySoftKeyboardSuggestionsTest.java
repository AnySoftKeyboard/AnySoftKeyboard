...
public class AnySoftKeyboardSuggestionsTest extends AnySoftKeyboardBaseTest {
    ...
    public void testPredictionOnInDefaultTextField() {
        final EditorInfo editorInfo = createEditorInfo(EditorInfo.IME_ACTION_NONE, EditorInfo.TYPE_CLASS_TEXT);
    ...
    public void testStripActionNotAddedWhenInNonPredictiveField() {
        ...
        final EditorInfo editorInfo = createEditorInfo(
    ...
    public void testWordComposerStaysEmptyWhenPredictionOffInNumberField() {
        simulateFinishInputFlow();
        final EditorInfo editorInfo = createEditorInfo(EditorInfo.IME_ACTION_NONE, EditorInfo.TYPE_CLASS_NUMBER);
        simulateOnStartInputFlow(false, editorInfo);
    ...
    public void testWordComposerStaysEmptyWhenPredictionOffInPhoneField() {
        simulateFinishInputFlow();
        final EditorInfo editorInfo = createEditorInfo(EditorInfo.IME_ACTION_NONE, EditorInfo.TYPE_CLASS_PHONE);
        simulateOnStartInputFlow(false, editorInfo);
    ...
    public void testSuggestionRestartCancelledWhenSwitchingToNonPredictiveField() {
        ...
        simulateFinishInputFlow();
        final EditorInfo passwordField = createEditorInfo(
                EditorInfo.IME_ACTION_NONE,
                EditorInfo.TYPE_CLASS_TEXT | EditorInfo.TYPE_TEXT_VARIATION_PASSWORD);
    ...
    public void testNoSuggestionMessagesExecuteAfterInputFinishes() {
        ...
        Assert.assertFalse(
                ...
                ((AnySoftKeyboardSuggestions) mAnySoftKeyboardUnderTest).mKeyboardHandler
                        .hasMessages(KeyboardUIStateHandler.MSG_UPDATE_SUGGESTIONS));
        Assert.assertFalse(
                "No restart suggestions message should remain after input finishes",
                ((AnySoftKeyboardSuggestions) mAnySoftKeyboardUnderTest).mKeyboardHandler
                        .hasMessages(MSG_RESTART_NEW_WORD_SUGGESTIONS));
    ...
    public void testClickingCancelPredicationHappyPath() {
        ...
        View rootActionView = provider
                .inflateActionView(mAnySoftKeyboardUnderTest.getInputViewContainer())
                .findViewById(R.id.close_suggestions_strip_root);
        final View.OnClickListener onClickListener = Shadows.shadowOf(rootActionView).getOnClickListener();
    ...
    public void testStripTheming() {
        final KeyboardThemeFactory keyboardThemeFactory = AnyApplication
                .getKeyboardThemeFactory(getApplicationContext());
        simulateFinishInputFlow();
    ...
    private void testDelayedOnSelectionUpdate(long delay) {
        final String testText = "typing 1 2 3 working hel kjasldkjalskdjasd hel fac ksdjflksd smile fac fac hel hel"
                + " aklsjdas gggggg hello fac hel face hel";
        final String expectedText = "typing 1 2 3 working he'll kjasldkjalskdjasd he'll face ksdjflksd smile face face"
