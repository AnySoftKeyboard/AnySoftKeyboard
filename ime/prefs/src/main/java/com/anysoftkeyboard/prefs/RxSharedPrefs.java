...
public class RxSharedPrefs {
  ...
  private static void upgradeSettingsValues(@NonNull SharedPreferences sp) {
    ...
    if (configurationVersion < 12) {
      ...
      if (!allValues.containsKey("settings_key_always_use_fallback_user_dictionary")) {
        ...
        final Editor editor = sp.edit();
        editor.putBoolean(
            "settings_key_always_use_fallback_user_dictionary", false /*the previous default*/);
        editor.apply();
      }
      ...
      if (allValues.containsKey("vibrate_on_key_press_duration")) {
        try {
          ...
          final Editor editor = sp.edit();
          editor.putInt("settings_key_vibrate_on_key_press_duration_int", previousVibrationValue);
  ...
  private static void applyAutoPrefsFile(
    ...
    if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
          ...
          final File appliedFile =
              new File(
                  ...
                  AUTO_APPLIED_PREFS_FILENAME_TEMPLATE.replace(
                      AUTO_APPLIED_PREFS_FILENAME_TEMPLATE_DATETIME_PLACEMENT, appliedTime));
          Logger.i(
              autoApplyLogTag,
      ...
      Logger.i(
          autoApplyLogTag, "Does not have WRITE_EXTERNAL_STORAGE to perform applyAutoPrefsFile.");
    }
  }
