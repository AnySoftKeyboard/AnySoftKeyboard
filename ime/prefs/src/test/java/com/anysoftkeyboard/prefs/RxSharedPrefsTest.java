...
public class RxSharedPrefsTest {
  ...
  public void testConvertBottomGenericRow() {
    ...
    Assert.assertTrue(
        preferences.contains("ext_kbd_enabled_1_3DFFC2AD-8BC8-47F3-962A-918156AD8DD0"));
    Assert.assertTrue(
        preferences.getBoolean("ext_kbd_enabled_1_3DFFC2AD-8BC8-47F3-962A-918156AD8DD0", false));
  }
  ...
  public void testDoesNotAutoApplyPrefFileIfNoPermission() throws Exception {
    ...
    final File autoApplyFile =
        new File(context.getExternalFilesDir(null), RxSharedPrefs.AUTO_APPLY_PREFS_FILENAME);
    ...
    Assert.assertFalse(
        Arrays.stream(listedFiles)
            .anyMatch(
                name ->
                    name.startsWith(RxSharedPrefs.AUTO_APPLIED_PREFS_FILENAME_TEMPLATE_PREFIX)));
  }
  ...
  public void testUpdatesStatisticsAndApplyFileOnlyWhenUserUnlocks() throws Exception {
    ...
    final File autoApplyFile =
        new File(application.getExternalFilesDir(null), RxSharedPrefs.AUTO_APPLY_PREFS_FILENAME);
