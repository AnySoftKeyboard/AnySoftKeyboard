...
public class EmojiUtilsTest {
  ...
  public void testRemoveSkinTone() {
    ...
    Assert.assertEquals(
        "\uD83D\uDC75",
        EmojiUtils.removeSkinTone("\uD83D\uDC75\uD83C\uDFFE", JavaEmojiUtils.SkinTone.Fitzpatrick_5)
            .toString());
    ...
    Assert.assertEquals(
        "\uD83D\uDC75\uD83C\uDFFE",
        EmojiUtils.removeSkinTone("\uD83D\uDC75\uD83C\uDFFE", JavaEmojiUtils.SkinTone.Fitzpatrick_2)
            .toString());
  }

  @Test
  public void testRemoveSkinToneGeneral() {
    Assert.assertEquals("\uD83D\uDC4D", JavaEmojiUtils.removeSkinTones("\uD83D\uDC4D").toString());
    Assert.assertEquals(
  ...
  public void testRemoveGenderGeneral() {
    Assert.assertEquals("\uD83D\uDC4D", JavaEmojiUtils.removeGenders("\uD83D\uDC4D").toString());
    Assert.assertEquals(
  ...
  public void testRemoveGender() {
    ...
    Assert.assertEquals(
        "\uD83E\uDDD4",
        EmojiUtils.removeGender("\uD83E\uDDD4\u200D♀", JavaEmojiUtils.Gender.Woman).toString());
    // woman-fully-qualified
    Assert.assertEquals(
        "\uD83E\uDDD4",
        EmojiUtils.removeGender("\uD83E\uDDD4\u200D♀️", JavaEmojiUtils.Gender.Woman).toString());
    // man-minimal-qualified-dark-skin
    Assert.assertEquals(
        "\uD83E\uDDD4\uD83C\uDFFF",
        EmojiUtils.removeGender("\uD83E\uDDD4\uD83C\uDFFF\u200D♂", JavaEmojiUtils.Gender.Man)
            .toString());
    // man-fully-qualified-dark-skin
    Assert.assertEquals(
        "\uD83E\uDDD4\uD83C\uDFFF",
        EmojiUtils.removeGender("\uD83E\uDDD4\uD83C\uDFFF\u200D♂️", JavaEmojiUtils.Gender.Man)
            .toString());
  }
}
