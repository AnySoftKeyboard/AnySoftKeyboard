...
#artifacts taken from: https://github.com/robolectric/robolectric/blob/robolectric-4.7.3/robolectric/src/main/java/org/robolectric/plugins/DefaultSdkProvider.java
ARTIFACTS=( \
