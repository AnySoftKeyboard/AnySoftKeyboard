...
echo "" >> "$TEMP_CONT_MD_FILE"
curl https://api.github.com/repos/AnySoftKeyboard/AnySoftKeyboard/contributors\?per_page\=200\&anon\=0 | jq -r '.[] | "1. [\(.login)](https://github.com/\(.login)) (\(.contributions))"' >> "$TEMP_CONT_MD_FILE"
